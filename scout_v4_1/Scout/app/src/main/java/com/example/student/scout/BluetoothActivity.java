...
public class BluetoothActivity extends AppCompatActivity {
  ...
  //  BluetoothDevice blueSensor = new BluetoothDevice("SENSOR", "98:D3:31:FB:7C:BB");
    ...
    boolean bBlue11 = false, bBlue22=false, bBlue33= false;
    ...
    private void scanPairing() {
        ...
        TargetThread targetThread1= null, targetThread2 = null, targetThread3 = null;

        while(target1 == null || target2 == null || target3 == null){
            ...
            //              BluetoothDevice device = new BluetoothDevice("SENSOR", "98:D3:31:FB:7C:BB");
                            targetThread1 = new TargetThread(target1);
                    ...
                    case "ENTER":
                        ...
                        if (!bBlue33){
                            ...
                            targetThread3 = new TargetThread(target3);
        ...
        if(targetThread1 != null || targetThread2 != null || targetThread3 != null){
